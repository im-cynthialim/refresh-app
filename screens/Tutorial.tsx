...
import { getDatabase, ref, set, update, onValue, remove, push, child } from 'firebase/database';
...
function TutorialScreen({ route, navigation }) {
  ...
  function addFood(productName, productType, productQuantity, productCategory, dateBought, dateStored, dateOpened, personalNotes, containerName, userId) {
    ...
    if (userId) {
      ...
      const updates = {};
      updates['userprofiles/' + JSON.stringify(userId) + '/containers/' + JSON.stringify(containerName) + '/foodList/' + newPostKey] = foodData;
  ...
  function FoodSetup({ route, navigation }) {
    ...
    const renderFoodList = ({ item }: { item: ProductData }) => {
      return (
        <View style={{
          flexDirection: 'row', backgroundColor: '#FBFEFB',
          shadowOffset: {
            height: 1,
            width: 0,
          },
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'flex-start', flex: 1, paddingHorizontal: 30, }}>
          ...
          <View style={{ alignSelf: 'center' }}>
            ...
            <Icon
              ...
              size={20}
            />
            <Text style={[styles.regularFont, { fontSize: 10, paddingTop: 2 }]}> Remove </Text>
            </Pressable>
          </View>
    ...
    return (
      <SafeAreaView style={{ backgroundColor: '#FBFEFB', height: '100%' }}>
        ...
        <View>
          ...
          // swipeDirection={'down'}
          >
            <View style={{ backgroundColor: '#FBFEFB', marginTop: '10%', justifyContent: 'flex-start', paddingTop: '10%', paddingHorizontal: '10%', flex: 1, borderTopLeftRadius: 21, borderTopRightRadius: 21 }}>
              ...
              <View style={{ alignItems: 'flex-start' }}>
                ...
                <Text style={[styles.regularFont, { paddingTop: 5, fontSize: 14, color: '#96979C', textAlign: 'left' }]}>
                         All factors will be shown on this screen no matter what you selected to display on the previous page
                  </Text>
              </View>
